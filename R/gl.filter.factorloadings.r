...
#' threshold. The threshold value is decided using gl.report.factorloadings.  
#' The function can be used to filter out loci that load high with a particular 
#' axis or alternatively if retain=TRUE, to retain loci that load high on a specified axis.  
#' 
#' Note that this function also removes monomorphic loci because PCA is 
#' performed only on polymorphic loci.
#' 
